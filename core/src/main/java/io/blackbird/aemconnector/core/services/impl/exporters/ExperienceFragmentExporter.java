...
public class ExperienceFragmentExporter extends AbstractPageExporter implements ContentExporter {


    @Activate
    public ExperienceFragmentExporter(@Reference ReferenceCollectorService referenceCollectorService,
